...
def _():
    ...
    # Assuming 'sales' is a Polars DataFrame loaded in a previous cell or elsewhere in the notebook
    # If not, you may need to load it, e.g., sales = pl.read_csv('path/to/sales.csv')
...
def _(pl, px):
    ...
    ex_fig3 = px.scatter(school_data,
     x = 'attendance_rate',
     y = 'test_score',
     color = 'grade_level',
     trendline = 'ols'
...
def _(category_sales, px):
    ...
    ex_fig4 = px.histogram(category_sales,
    x="total_amount",
